...
public class conexionReserva {
    ...
    public boolean insertar(claseReserva dts) {
    ...
    public boolean editar(claseReserva dts) {
    ...
    public boolean pagar(claseReserva dts) {
    ...
    public boolean eliminar(claseReserva dts) {
