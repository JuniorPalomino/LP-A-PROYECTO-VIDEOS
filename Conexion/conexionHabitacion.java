...
public class conexionHabitacion {
    ...
    private conexionBD mysql = new conexionBD(); //creacion de instacia de conexionBD
    private Connection cn = mysql.conectar(); //creamos un objeto a Connection y declaramos la funcion "conectar"
    private String sSQL = ""; //declaramos un string para almacenar cadena de conexionBD
...
//Usamos diversos metodos para cambiar y operar los atributos de la habitacion   
    ...
    public boolean insertar(claseHabitacion dts) {
    ...
    public boolean editar(claseHabitacion dts) {
    ...
    public boolean desocupar(claseHabitacion dts) {
    ...
    public boolean ocupar(claseHabitacion dts) {
    ...
    public boolean eliminar(claseHabitacion dts) {
