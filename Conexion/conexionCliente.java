...
public class conexionCliente {
    ...
    public DefaultTableModel mostrar(String buscar) {
        ...
        String[] registro = new String[10]; //indices segun la variable "titulos"
    ...
    public boolean insertar(claseCliente dts) {
        sSQL = "insert into persona (nombre,apaterno,amaterno,tipo_documento,num_documento,direccion,telefono,email)"
                + "values (?,?,?,?,?,?,?,?)";       //se inserta en persona, base de datos
        sSQL2 = "insert into cliente (idpersona,codigo_cliente)"
                + "values ((select idpersona from persona order by idpersona desc limit 1),?)"; //se inserta en cliente, base de datos
        try {
    ...
    public boolean editar(claseCliente dts) {
    ...
    public boolean eliminar(claseCliente dts) {
